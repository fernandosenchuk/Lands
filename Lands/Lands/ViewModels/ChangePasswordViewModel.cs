namespace Lands.ViewModels
{
    ...
    public class ChangePasswordViewModel : BaseViewModel
    {
        ...
        private async void ChangePassword()
        {
            ...
            if (this.CurrentPassword != MainViewModel.GetInstance().UserLocal.Password)
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
            ...
            var request = new ChangePasswordRequest
            {
                ...
                Email = MainViewModel.GetInstance().UserLocal.Email,
            ...
            MainViewModel.GetInstance().UserLocal.Password = this.NewPassword;
            this.dataService.Update(MainViewModel.GetInstance().UserLocal);
